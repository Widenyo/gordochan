...
const getPosts = async (res, page, short, user) => {
    ...
    if(postsQuery.length === 0) return res.render('board', {user: user, posts: false, banner: getRandomBanner(), boardId: await getBoardId(short)});
